<template>
	<u-popup mode="center" :class="customClass" :zoom="zoom" :show="show" :customStyle="{
			borderRadius: '6px', 
			overflow: 'hidden',
			marginTop: `-${$u.addUnit(negativeTop)}`
		}" :closeOnClickOverlay="closeOnClickOverlay" :safeAreaInsetBottom="false" :duration="duration"
		@click="clickHandler">
		<view class="u-modal" :style="{
			...
			<view class="u-modal__content" :style="{
					padding: contentPadStyle || (title ? '24rpx' : '50rpx'),  
					    paddingTop: contentPadStyle ? undefined : (title ? '24rpx' : '50rpx')
				}">
				<slot>
			...
			<template v-else>
				...
				<view class="u-modal__button-group" :style="{
					...
					<view class="u-modal__button-group__wrapper u-modal__button-group__wrapper--cancel"
						:hover-stay-time="150" hover-class="u-modal__button-group__wrapper--hover"
					...
					<view class="u-modal__button-group__wrapper u-modal__button-group__wrapper--confirm"
						:hover-stay-time="150" hover-class="u-modal__button-group__wrapper--hover"
