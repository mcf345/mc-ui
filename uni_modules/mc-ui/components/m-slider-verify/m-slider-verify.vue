<template>
	<view class="m-slider-verify-box" v-if="isShow">
		<view class="verifyBox">
			<view class="m-slider-title">图形验证</view>
			<view class="slide-content">
				<view class="slide-tips">拖动下方滑块完成拼图</view>
				<view class="m-slider-pintu">
					<image id="pintuImg" :src="require('./static/images/' + img + '.jpg')" class="pintu"></image>
				...
				<view class="m-slider-movearea" @touchend="endTouchMove">
			...
			<view class="m-slider-btn-group">
				<view class="m-slider-btn" @tap="closeSlider">关闭</view>
				<view class="m-slider-btn slide-btn-refresh" @tap="refreshVerify">刷新</view>
			</view>
		</view>
	</view>
</template>
	...
	.m-slider-movearea {
		...
		movable-area {
			...
			movable-view {
				...
				background-image: url(./static/images/icon-button-normal.png);
