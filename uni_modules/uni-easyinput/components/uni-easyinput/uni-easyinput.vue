<template>
	<view class="uni-easyinput" :class="{ 'uni-easyinput-error': msg }" :style="boxStyle">
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
			...
			<input v-else :inputmode="readonly ? 'none' : 'type'" :type="type === 'password' ? 'text' : type"
				...
				:cursor-spacing="cursorSpacing" @focus="_Focus" @blur="_Blur" @input="onInput" @confirm="onConfirm"
